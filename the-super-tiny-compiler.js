...
/**
 * ほとんどのコンパイラは3つの主要な段階(stage)を踏みます: パース, トランスフォーム, コード生成
 *
 * 1. 「パース」は生のコードを、より抽象表現に変えることです。
 *
 * 2. 「トランスフォーム」は、抽象表現を受け取り、コンパイラの望む形に加工します。
 *
 * 3. 「コード生成」は、トランスフォームされたコードを受け取り新しいコードを生成します。
 *
 */
 ...
 *   }
 *
 * ASTをトランスフォームする際には、プロパティの追加・削除・置換によってノードを操作することができ、
 ...
 *
 * コンパイラの最終段階はコード生成です。
 * コンパイラは、トランスフォームと重複することをすることもありますが、
